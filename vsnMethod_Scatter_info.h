...
//
#ifndef _VSN_METHOD_SCATTER_INFO_H_
#define _VSN_METHOD_SCATTER_INFO_H_
...
public:
  vsnMethod_Scatter_info(const std::string& nm=std::string(VFR_NONAME));
  virtual ~vsnMethod_Scatter_info();
...
#endif // _VSN_METHOD_SCATTER_INFO_H_
